...
('Soins du visage', 'Produits pour le soin et la beauté du visage', 'soins-visage'),
('Maquillage', 'Produits de maquillage et cosmétiques', 'maquillage'),
('Soins des lèvres', 'Produits spécialisés pour les lèvres', 'soins-levres'),
('Perruques', 'Perruques et accessoires capillaires', 'perruques');
...
('Lip Gloss Ultra-hydratants', 'Lip gloss brillants et ultra-hydratants signés Queen''s Glam', 
 (SELECT id FROM product_categories WHERE slug = 'soins-levres'), 28.50, 50, 'QG-LG-001'),
('Masques à Lèvres', 'Masques adoucissants et régénérants pour des lèvres parfaites', 
 (SELECT id FROM product_categories WHERE slug = 'soins-levres'), 22.00, 30, 'QG-ML-001'),
('Perruques Naturelles', 'Perruques haut de gamme, confortables et stylées', 
 (SELECT id FROM product_categories WHERE slug = 'perruques'), 150.00, 15, 'QG-PN-001');
